...
function animateMaskingText1() {
    ...
    // Add typewriter effect to .masking-text
    const maskingTexts = document.querySelectorAll(".masking-text");
    maskingTexts.forEach((textElement) => {
...
// Call the functions to animate the header text, wellness description, icons, border, masking-text1, and typewriter effect
animateHeaderText();
