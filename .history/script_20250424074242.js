...
function setupPageTransitions() {
  ...
  links.forEach((link) => {
    link.addEventListener("click", (e) => {
      ...
      // Slide in overlay from left with blur
      transitionTimeline.set(overlay, { left: "-100%", filter: "blur(0px)" });
  ...
  // On page load: slide overlay out to the right
  gsap.fromTo(
    overlay,
    { left: "0%", filter: "blur(3px)" },
    {
      left: "100%",
      duration: 0.7,
      ease: "power4.inOut",
