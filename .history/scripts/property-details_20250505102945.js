...
async function fetchPropertyDetails() {
  ...
  document.getElementById('host-name').textContent = property.host_name;
  document.getElementById('host-photo').src = property.host_photo_url;
  document.getElementById('host-bio').textContent = property.host_bio;
